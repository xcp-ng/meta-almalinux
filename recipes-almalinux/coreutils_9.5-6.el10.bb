...
RPROVIDES:coreutils:x86_64_v2 = "virtual//usr/bin/basename virtual//usr/bin/chmod virtual//usr/bin/date virtual//usr/bin/env virtual//usr/bin/head virtual//usr/bin/readlink virtual//usr/bin/realpath virtual//usr/bin/sha512sum virtual//usr/bin/tr virtual/coreutils"
...
RPROVIDES:coreutils-single:x86_64_v2 = "virtual//usr/bin/basename virtual//usr/bin/chmod virtual//usr/bin/date virtual//usr/bin/env virtual//usr/bin/head virtual//usr/bin/readlink virtual//usr/bin/realpath virtual//usr/bin/sha512sum virtual//usr/bin/tr virtual/coreutils"
...
RPROVIDES:coreutils:aarch64 = "virtual//usr/bin/basename virtual//usr/bin/chmod virtual//usr/bin/date virtual//usr/bin/env virtual//usr/bin/head virtual//usr/bin/readlink virtual//usr/bin/realpath virtual//usr/bin/sha512sum virtual//usr/bin/tr virtual/coreutils"
...
RPROVIDES:coreutils-single:aarch64 = "virtual//usr/bin/basename virtual//usr/bin/chmod virtual//usr/bin/date virtual//usr/bin/env virtual//usr/bin/head virtual//usr/bin/readlink virtual//usr/bin/realpath virtual//usr/bin/sha512sum virtual//usr/bin/tr virtual/coreutils"
...
PROVIDES:append:x86_64_v2 = " rpm/virtual//usr/bin/basename rpm/virtual//usr/bin/chmod rpm/virtual//usr/bin/date rpm/virtual//usr/bin/env rpm/virtual//usr/bin/head rpm/virtual//usr/bin/readlink rpm/virtual//usr/bin/realpath rpm/virtual//usr/bin/sha512sum rpm/virtual//usr/bin/tr rpm/virtual/coreutils"

PROVIDES:append:aarch64 = " rpm/virtual//usr/bin/basename rpm/virtual//usr/bin/chmod rpm/virtual//usr/bin/date rpm/virtual//usr/bin/env rpm/virtual//usr/bin/head rpm/virtual//usr/bin/readlink rpm/virtual//usr/bin/realpath rpm/virtual//usr/bin/sha512sum rpm/virtual//usr/bin/tr rpm/virtual/coreutils"
