...
URI_src = "${ALMALINUXSRC_MIRROR}/AppStream/Source/Packages/python-augeas-1.1.0-14.el10.src.rpm;name=src;unpack=0"
SRC_URI = "${URI_src}"
...
URI_aarch64_python3-augeas = "${ALMALINUX_MIRROR}/AppStream/aarch64/os/Packages/python3-augeas-1.1.0-14.el10.noarch.rpm;name=aarch64_python3-augeas;unpack=0"
SRC_URI:append = " ${URI_aarch64_python3-augeas}"
