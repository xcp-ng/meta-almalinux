...
URI_aarch64_mingw32-pcre2 = "${ALMALINUX_MIRROR}/CRB/aarch64/os/Packages/mingw32-pcre2-10.42-8.el10.noarch.rpm;name=aarch64_mingw32-pcre2;unpack=0"
SRC_URI:append = " ${URI_aarch64_mingw32-pcre2}"
SRC_URI[aarch64_mingw32-pcre2.sha256sum] = "7caef9a8235081454db10c4049b6a21723a9900a8516b724ed9a21482ddfb5a6"

URI_aarch64_mingw32-pcre2-static = "${ALMALINUX_MIRROR}/CRB/aarch64/os/Packages/mingw32-pcre2-static-10.42-8.el10.noarch.rpm;name=aarch64_mingw32-pcre2-static;unpack=0"
SRC_URI:append = " ${URI_aarch64_mingw32-pcre2-static}"
SRC_URI[aarch64_mingw32-pcre2-static.sha256sum] = "7e5591c74a10fbf9071fc81c55c16e461a551fb68e3b13a6dfcc662a1646e98d"

URI_aarch64_mingw64-pcre2 = "${ALMALINUX_MIRROR}/CRB/aarch64/os/Packages/mingw64-pcre2-10.42-8.el10.noarch.rpm;name=aarch64_mingw64-pcre2;unpack=0"
SRC_URI:append = " ${URI_aarch64_mingw64-pcre2}"
SRC_URI[aarch64_mingw64-pcre2.sha256sum] = "f762f0472919caf5555eaa308922886884f161318b88979f43994c382cf3c2cd"

URI_aarch64_mingw64-pcre2-static = "${ALMALINUX_MIRROR}/CRB/aarch64/os/Packages/mingw64-pcre2-static-10.42-8.el10.noarch.rpm;name=aarch64_mingw64-pcre2-static;unpack=0"
SRC_URI:append = " ${URI_aarch64_mingw64-pcre2-static}"
SRC_URI[aarch64_mingw64-pcre2-static.sha256sum] = "8e92ce698e145cb61fdf1e52ad2abc0e72cf87816e6f0ce10f95cfad79cbabc8"
